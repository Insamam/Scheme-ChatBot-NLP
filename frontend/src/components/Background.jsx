...
import anime1 from '../assets/anime1.gif'; // Import the anime1.gif image

const Background = () => {
  return (
    <div className="h-screen w-screen bg-gradient-to-r from-purple-900 via-gray-900 to-black flex items-center justify-center">
      <div className="absolute left-16 top-24 h-1/4 w-1/4 bg-cover bg-center mr-28 mt-10" style={{ backgroundImage: `url(${anime1})`, maxWidth: '180px', maxHeight: '150px' }}></div>
